...
Public Class ManageController
    ...
    '
    ' GET: /Manage/Index
    Public Async Function Index(message As ManageMessageId?) As Task(Of ActionResult)
    ...
    Public Async Function ManageLogins(message As ManageMessageId?) As Task(Of ActionResult)
